          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action"> 
                        <a  title="{{__('تعديل')}}" href="/admin/editProvider/{{$provider['provider']->id}}"><i data-feather="edit"></i></i></a>
                        <a  title="{{__('تجميد')}}" href="/admin/blockProvider/{{$provider['provider']->id}}"><i data-feather="slash"></i></i></a>
                    </td>
                </tr>
              @endforeach
            </tbody>
