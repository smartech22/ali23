		...
		<script src="front_end/assets/js/popper.min.js"></script>
		<script src="front_end/assets/js/bootstrap.min.js"></script>

		<!-- animation - jquery include -->
		<script src="front_end/assets/js/aos.js"></script>
		<script src="front_end/assets/js/parallaxie.js"></script>

		<!-- carousel - jquery include -->
		<script src="front_end/assets/js/slick.min.js"></script>

		<!-- popup - jquery include -->
		<script src="front_end/assets/js/magnific-popup.min.js"></script>

		<!-- select ontions - jquery include -->
		<script src="front_end/assets/js/nice-select.min.js"></script>

		<!-- isotope - jquery include -->
        <script src="front_end/assets/js/isotope.pkgd.js"></script>
        <script src="front_end/assets/js/imagesloaded.pkgd.min.js"></script>
        <script src="front_end/assets/js/masonry.pkgd.min.js"></script>

		<!-- google map - jquery include -->
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
        <script src="front_end/assets/js/gmaps.min.js"></script>

		<!-- pricing range - jquery include -->
		<script src="front_end/assets/js/jquery-ui.js"></script>

		<!-- counter - jquery include -->
		<script src="front_end/assets/js/waypoint.js"></script>
		<script src="front_end/assets/js/counterup.min.js"></script>

		<!-- contact form - jquery include -->
        <script src="front_end/assets/js/validate.js"></script>

		<!-- mobile menu - jquery include -->
        <script src="front_end/assets/js/mCustomScrollbar.js"></script>

		<!-- custom - jquery include -->
		<script src="front_end/assets/js/custom.js"></script>
