	...
	@include('front-end.layout-pages.header')
			...
			<section class="breadcrumb_section text-center clearfix">
				<div class="page_title_area has_overlay d-flex align-items-center clearfix" data-bg-image="front_end/assets/images/breadcrumb/bg_09.jpg">
						...
						<div class="row align-items-center">
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<div class="reg_image" data-aos="fade-up" data-aos-delay="300">
									<img src="front_end/assets/images/about/img_03.jpg" alt="image_not_found">
								</div>
							</div>
						...
						<form action="#">
							<div class="row justify-content-lg-between">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="700">
									...
									<button type="submit" class="custom_btn bg_default_red text-uppercase mb-0">Login <img src="front_end/assets/images/icons/icon_01.png" alt="icon_not_found"></button>
								</div>
							</div>
						</form>
					</div>
