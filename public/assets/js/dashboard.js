$(function() {
  ...
  if($('#monthlySalesChart').length) {
    ...
    var e = input5.value ;
    const input6 = document.getElementById("six");
    var f = input6.value ;
    const input7 = document.getElementById("seven");
    var g = input7.value ;
    const input8 = document.getElementById("first");
    var h = input8.value ;
    const input9 = document.getElementById("second");
    var k = input9.value ;
    const input10 = document.getElementById("third");
    var l = input10.value ;
    const input11 = document.getElementById("forth");
    var m = input11.value ;
    const input12 = document.getElementById("fifth");
    var n = input12.value ;
    const input13 = document.getElementById("sixth");
    var o = input13.value ;
    const input14 = document.getElementById("seventh");
    var p = input14.value ;
    var options = {
      chart: {
        type: 'bar',
  ...
  if ($('#storageChart').length) {
     const input = document.getElementById("financial");
     var a = input.value ;
    var options = {
      chart: {
        height: 260,
